            ...
            <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input type="text" name="name" placeholder="David Singh" value={formData.name} onChange={handleChange} className="input-field" style={{ paddingLeft: '44px', marginBottom: 0 }} required />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input type="email" name="email" placeholder="name@example.com" value={formData.email} onChange={handleChange} className="input-field" style={{ paddingLeft: '44px', marginBottom: 0 }} required />
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px' }}>
                 <div style={{ flex: 1 }}>
                   ...
                   <div style={{ position: 'relative' }}>
                     ...
                     <input type="password" name="password" placeholder="••••••••" value={formData.password} onChange={handleChange} className="input-field" style={{ paddingLeft: '44px', marginBottom: 0 }} required />
                   </div>
                 </div>
                 <div style={{ flex: 1 }}>
                   ...
                   <div style={{ position: 'relative' }}>
                     <Lock size={18} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)' }} />
                     <input type="password" name="confirmPassword" placeholder="••••••••" value={formData.confirmPassword} onChange={handleChange} className="input-field" style={{ paddingLeft: '44px', marginBottom: 0 }} required />
                   </div>
                 </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginTop: '8px', marginBottom: '8px' }}>
                ...
                <label htmlFor="consent" style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.5', cursor: 'pointer' }}>
                  I consent to the collection and processing of my health data as outlined in the <a href="/public" style={{ color: 'var(--accent-blue)', textDecoration: 'none' }}>Privacy Policy</a>. *
                </label>
              </div>
